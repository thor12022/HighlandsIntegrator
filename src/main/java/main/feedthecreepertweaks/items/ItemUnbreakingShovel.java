...
public class ItemUnbreakingShovel extends ItemSpade
{
   private String displayName;
   
   public ItemUnbreakingShovel(ToolMaterial toolMaterial, String name, String texture)
   {
      super(toolMaterial);
   ...
   {
      return stack.getItem() instanceof ItemUnbreakingShovel;
   }
}
