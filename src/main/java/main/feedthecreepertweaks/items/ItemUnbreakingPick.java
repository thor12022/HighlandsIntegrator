...
public class ItemUnbreakingPick extends ItemPickaxe
{
   public ItemUnbreakingPick(ToolMaterial toolMaterial, String name, String texture)
   {
      super(toolMaterial);
   ...
   {
      return stack.getItem() instanceof ItemUnbreakingPick;
   }
}
