...
public class ItemUnbreakingHoe extends ItemHoe
{
   private String displayName;
   
   public ItemUnbreakingHoe(ToolMaterial toolMaterial, String name, String texture)
   {
      super(toolMaterial);
   ...
   {
      return stack.getItem() instanceof ItemUnbreakingHoe;
   }
}
